...
public class Banking {
    public static final String JDBC_URL = "jdbc:mysql://localhost:3306/netbanking";
...
class BankEmployee1 {
    ...
    private Connection connect() throws SQLException {
        return DriverManager.getConnection(Banking.JDBC_URL, Banking.USERNAME, Banking.PASSWORD);
    }
    ...
    private static CustomerAccount findAccount(Connection connection, int accountNumber) throws SQLException {
    ...
    public void openNewAccount() {
        try (Connection connection = connect()) {
            ...
            try (PreparedStatement preparedStatement = connection.prepareStatement(
                ...
                preparedStatement.setDouble(2, initialDeposit);
                ...
                if (affectedRows > 0) {
                    try (ResultSet generatedKeys = preparedStatement.getGeneratedKeys()) {
                        if (generatedKeys.next()) {
                            ...
                            System.out.println("Account opened successfully for " + name + ". Account Number: " + accountNumber + ", Initial Balance: " + initialDeposit);
                        }
                    }
                } else {
